...
<head>
    ...
    <link href="<?php echo e(asset('css/appedited.css')); ?>" rel="stylesheet">
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <li class="nav-item">
                    <a href="<?php echo e(route('admin.impersonate.destroy')); ?>">Stop Impersonating</a>
                    </li>
                     <?php endif; ?>
                    </ul>
...
<?php /**PATH C:\xampp\htdocs\PsychThesis\resources\views/layouts/app.blade.php ENDPATH**/ ?>