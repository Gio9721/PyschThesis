...
<section>
    <div id="app">
        <header>
            <a href="#" class="logo">Add Account</a>
            <ul>
        ...
        <?php echo $__env->make('partials.alerts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <div class="container">
                <div class="examscard">
                    <div class="card-body">
                        <form method="PUT" id="addaccount" action="<?php echo e(route('user.create')); ?>">
                                                <?php echo csrf_field(); ?>
                        <div class="row">
                            <div class="col-8 col-sm-6">
                                ...
                                <div class="input-group mb-3">
                                    <label class="input-group-text" for="course" ><?php echo e(__('Course')); ?></label>
                                ...
                                <div class="input-group mb-3">
                                    <label class="input-group-text" for="year" ><?php echo e(__('Year')); ?></label>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\PsychThesis\resources\views/admin/users/addaccount.blade.php ENDPATH**/ ?>